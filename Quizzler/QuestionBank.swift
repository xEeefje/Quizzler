...
class QuestionBank {
    //variabele met een array dat alleen Question objecten bevat
    var list = [Question]()
    ...
    init() {
        ...
        // Add the Question to the list of questions. Append voegt de vraag toe aan het eind van de array
        list.append(item)
